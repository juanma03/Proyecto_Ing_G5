...
User.create(last_name:'Lopez', name: 'Axel',  email: 'ngaldamez@lidi.info.unlp.edu.ar', phone: '2214257855', address: 'Calle falsa 123', password: '12345678', password_confirmation: '12345678', credit_card_number: '1234567890123456', credit_card_owner: 'PadreDeAxel', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)

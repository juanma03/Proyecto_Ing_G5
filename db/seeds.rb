...
User.create(last_name:'Galdamez', name: 'Nicolas',  email: 'ngaldamez@lidi.info.unlp.edu.ar', phone: '2214257855', address: 'Calle falsa 123', password: '12345678', password_confirmation: '12345678', credit_card_number: '1234567890123456', credit_card_owner: 'PadreDeAxel', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: true)
User.create(last_name:'Maica', name: 'Juan',  email: 'juanma.m21@hotmail.com', phone: '2214212354', address: 'Calle falsa 321', password: '87654321', password_confirmation: '87654321', credit_card_number: '2345678900000987', credit_card_owner: 'PadreDeJuanma', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Fulanito', name: 'Cosme',  email: 'cosmef@hotmail.com', phone: '2214212355', address: 'Calle falsa 322', password: '87654321', password_confirmation: '87654321', credit_card_number: '1111111111111112', credit_card_owner: 'CosmeSr', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Acunia', name: 'Cesar',  email: 'axl_lp@hotmail.com', phone: '2214212355', address: 'Calle falsa 322', password: '87654321', password_confirmation: '87654321', credit_card_number: '1111111111111113', credit_card_owner: 'CesarSr', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Tito', name: 'Rober',  email: 'rober@hotmail.com', phone: '2214212356', address: 'Calle falsa 323', password: '87654321', password_confirmation: '87654321', credit_card_number: '1111111111111114', credit_card_owner: 'RoberSr', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Landa', name: 'Lalo',  email: 'lalola@hotmail.com', phone: '2214212357', address: 'Calle falsa 324', password: '87654321', password_confirmation: '87654321', credit_card_number: '1111111111111115', credit_card_owner: 'LaloSr', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
...
Offer.create(user_id: 2, publication_id: 2 , amount: 500, necessity: 'Siempre me gustaron los animales porque vivo solo y son buena compania. Una llama es justo lo que necesito.', security_code: '123')

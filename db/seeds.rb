...
User.create(last_name:'Fulanito', name: 'Cosme',  email: 'cosmef@hotmail.com', phone: '2214212355', address: 'Calle falsa 322', password: '87654321', password_confirmation: '87654321', credit_card_number: '', credit_card_owner: '', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Acunia', name: 'Cesar',  email: 'axl_lp@hotmail.com', phone: '2214212355', address: 'Calle falsa 322', password: '87654321', password_confirmation: '87654321', credit_card_number: '', credit_card_owner: '', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Tito', name: 'Rober',  email: 'rober@hotmail.com', phone: '2214212356', address: 'Calle falsa 323', password: '87654321', password_confirmation: '87654321', credit_card_number: '', credit_card_owner: '', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)
User.create(last_name:'Landa', name: 'Lalo',  email: 'lalola@hotmail.com', phone: '2214212357', address: 'Calle falsa 324', password: '87654321', password_confirmation: '87654321', credit_card_number: '', credit_card_owner: '', credit_card_expiration_date: Time.now + 2.years, adult: true, city: 'La Plata',admin: false)

...
$( function() {
  // init Isotope
  var $container = $('.ordenador').isotope({
    itemSelector: '.item',
    layoutMode: 'fitRows',
    getSortData: {
      name: '.name',
      ...
      expiration: function (itemElem) {
        var dateStr = $(itemElem).find('.expiration').text();
        dateArray = dateStr.split('/');
        year = dateArray[2];
        month = dateArray[1];
        day = dateArray[0];
      ...
      expiration_inv: function (itemElem) {
        var dateStr = $(itemElem).find('.expiration').text();
        dateArray = dateStr.split('/');
        year = dateArray[2];
        month = dateArray[1];
...
$container.imagesLoaded( function() {
  ...
  $('#sorts').on( 'click', 'a', function() {
    ...
    switch(sortValue) {
      ...
      break;
      case "expiration_inv":
      $container.isotope({ sortBy: 'expiration', sortAscending: false });
      break;
      default:
